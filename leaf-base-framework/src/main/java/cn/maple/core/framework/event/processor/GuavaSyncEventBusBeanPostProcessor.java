 ...
 * Guava同步事件总线Bean后处理器
 * <p>
 * 自动检测并注册带有@Subscribe注解的方法到同步事件总线
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        try {
            ...
            for (Method method : methods) {
                ...
                for (Annotation annotation : annotations) {
                    ...
                    if (annotation != null && annotation.annotationType().equals(Subscribe.class)) {
                        ...
                        log.info("在Bean[{}]中发现@Subscribe注解的方法[{}]，注册到Guava同步事件总线", beanName, method.getName());
                        break;
                    }
                }
            ...
            if (hasSubscribeMethod) {
                ...
                log.info("成功将Bean[{}]注册到Guava同步事件总线", beanName);
            }
        } catch (Exception e) {
