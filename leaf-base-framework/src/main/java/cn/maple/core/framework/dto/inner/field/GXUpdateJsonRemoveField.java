...
public class GXUpdateJsonRemoveField extends GXUpdateField<String> {
    ...
    public String updateString() {
        ...
        if (CharSequenceUtil.isEmpty(tableNameAlias)) {
            return CharSequenceUtil.format("{} = JSON_REMOVE({}, #{{}})", fieldName, fieldName, pathParamName);
        }
        return CharSequenceUtil.format("{}.{} = JSON_REMOVE({}.{}, #{{}})", tableNameAlias, fieldName, tableNameAlias, fieldName, pathParamName);
    }
